      ...
      <div class="mb-6">
        <div class="flex flex-col sm:flex-row gap-4">
          ...
          <div class="sm:w-full">
            ...
            <div v-if="paymentMethod === 'credit_card'" className="text-sm border rounded p-2 mb-3 space-y-2">
              <p className="font-medium">Account info:</p>
              <p>Bank: Vietcombank</p>
              <p>Account number: 1234567890</p>
              <p>Account: ODENO Corps</p>
              <p className="mt-2 text-gray-400">Please note the transation content as: "[Your name] book tickets for [Movie name]"</p>
            </div>
            <div v-else class="text-sm mb-3 text-gray-400">
              Please checkout when you arrive at our theater.
            </div>

            <!-- Bill Image Link for Credit Card -->
            <div v-show="paymentMethod === 'credit_card'" class="mb-4">
...
function confirmCheckout() {
  const checkoutData = {
    ...
    billImageLink: paymentMethod.value === 'credit_card' ? billImageLink.value : null,
  };
